...
void read_seismo(real ***&rtf_uz, real ***&rtf_ux, int nrec, int nt, int ishot); // reading reciever seismograms
void read_seismo_src(real **&stf_uz, real **&stf_ux, int nsrc, int nt); // Reading source seismograms
