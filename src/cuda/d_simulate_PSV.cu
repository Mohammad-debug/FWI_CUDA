...
//   real C_lam = thrust::reduce(dev_ptr1, dev_ptr1+nz*nx, 0, thrust::plus<real>());
//    real C_mu = thrust::reduce(dev_ptr2, dev_ptr2+nz*nx, 0, thrust::plus<real>());
//    real C_rho = thrust::reduce(dev_ptr3, dev_ptr3+nz*nx, 0, thrust::plus<real>());

// std::cout<<"This is test************** "<<C_rho<<" "<<C_lam<<" "<<C_mu<<" \n";
